                ...
                <div className="aboutUs">
                    ...
                    <div className="aboutUs--desc">
                        <p>We believe that books have the power to change lives, and we're dedicated to helping our
                            ...
                            an educational read, or a book to inspire you, we've got you covered.
                        <br/>
                            <br/>
                        Thank you for choosing to shop with us. We look forward to helping you discover your next
                            favorite book!</p>
                    </div>
                </div>
            </div>
